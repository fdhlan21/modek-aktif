...
<div class="header-container">
    <div class="content-header">
       <a href="<?= base_url('rencanapemulihan/latihanrentangerak') ?>"><img src="../assets/img/icon/lef.png" alt=""></a>
    </div>

    <div class="content-header">
        <h3>Latihan Range of Motion</h3>
    </div>
...
<div class="main-container">
    <div class="vid-container">
        <div class="vid">
            <iframe src="https://www.youtube.com/embed/NOYkm-O78pQ" 
